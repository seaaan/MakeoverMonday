---
title: '2017 week 32: Toilets in India'
...
to_plot <- improvements %>% 
    mutate(Type = ifelse(str_detect(Category, "Girls"), "Women", "All")) %>% 
...
ggplot(to_plot, aes(x = reorder(State, Improvement, mean), 
    ...
    ggtitle("Large sanitation improvements in India") + 
    labs(subtitle = 
            paste0("The availability of functioning toilets increased in almost ",
                "every Indian\nstate between 2010 and 2016. Improvements were ", 
                "even greater\nfor women's toilets than for all toilets."))
